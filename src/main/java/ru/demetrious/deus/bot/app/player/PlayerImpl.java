...
public class PlayerImpl implements Player {
    ...
    @Override
    public void connect(CommandAdapter commandAdapter) {
        VoiceChannel voiceChannel = commandAdapter.getVoiceChannel();
        AudioManager audioManager = commandAdapter.getAudioManager();
