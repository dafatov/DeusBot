...
@Component
public class SaveGamePacksUseCase implements SaveGamePacksInbound {
    private final SaveGamePacksOutbound saveGamePacksOutbound;
    ...
    public void savePacks(MultipartFile[] packs) {
        ...
        for (MultipartFile file : packs) {
            try {
                ...
                saveGamePacksOutbound.savePack(pack);
            } catch (IOException e) {
